function sendMail() {
  ...
  for (var i in data){
    ...
    message = "Dear " + name +", <br>Greetings of the day.<br><br>I hope this email finds you well. My name is Vikranth Udandarao, and I am reaching out to you from XYZ Company. We came across your profile and were impressed by your accomplishments in the field of " + category +". We believe that your expertise would be a great fit for our upcoming project. <br><br>We would love to have a conversation with you about potential collaboration opportunities. Please let us know a suitable time for you, and we will arrange a call accordingly. <br><br>Looking forward to hearing from you soon. <br><br>Best Regards, <br><br>Vikranth Udandarao <br>XYZ <br>+91 98xxxxxxxx | vikranth@xyz.com";
    var options = {
      "htmlBody":message
    }
